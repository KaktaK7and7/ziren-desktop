                    ...
                    <article className="settings-feature-card">
                      <div className="settings-feature-top">
                        <div>
                          ...
                          <span>
                            Скажи: «что у меня на экране», «переведи этот
                            текст», «объясни ошибку» или «помоги решить эту
                            задачу». Мелисса сможет разобрать интерфейс,
                            перевести видимый текст, объяснить сообщение об
                            ошибке, подсказать следующий шаг, помочь с учебной
                            или рабочей задачей и кратко пересказать содержимое.
                            Ziren делает только один снимок основного экрана по
                            явной просьбе, передаёт его для текущего ответа и не
                            добавляет изображение в память.
                          </span>
                        </div>
                        <strong className="settings-companion-status">
                          ONLY ON REQUEST
                    ...
                    <article className="settings-feature-card">
                      <div className="settings-companion-control">
                        <div>
                          ...
                          <p>
                            После тишины Мелисса сама возвращается к текущей
                            нити: может предложить проверку, дать конкретную
                            задачу, потребовать решение или возразить, а не
                            только задать вопрос. Для новых установок функция
                            включена; её всегда можно отключить здесь.
                          </p>
                        </div>
                        <label className="settings-switch">
                          <input
